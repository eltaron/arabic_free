...
<section class="section_main">
    ...
    <section dir="rtl" class="section6 mt-3">
        <div class="container">
            ...
            ?>
                <?php foreach($activities as $activity) { ?>
                    <div class="main_item text-right">
                        ...
                        <span class="text-left data_span"><?php echo $activity['post_data'];?><i class="icofont-ui-calendar"></i></span>
                        <?php
                                                if (isset($activity['post_image']) && $activity['post_image'] !== '') {
                                                    ...
                                                    echo '<img src="assets/img/exam.jpg" class="card-img-top" style="height: 450px;">';
                                                }
                                            ?>
                        
                        <div class="buttons mt-3 text-center">
                            <button class="main btn show_btn" data-show_item="show">التعليقات <i class="icofont-comment"></i></button>
                            <button class="main btn show_btn" data-show_item="add">اضافة تعليق </button>
                        </div>
                        ...
                        <div class="add_comment show_item" id="add">
                            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                                ...
                                <button type="button" class="btn btn-orange">اضافة تعليق</button>
                            </form>
                        </div>
                    </div>
                    <hr>
